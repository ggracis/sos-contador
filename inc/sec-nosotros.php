...
<div class="container clearfix">
	...
	<div class="row justify-content-center col-mb-50">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="feature-box fbox-center fbox-effect border-bottom-0 fadeIn animated" data-animate="fadeIn" data-delay="800">
				<div class="fbox-icon">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="feature-box fbox-center fbox-effect border-bottom-0 fadeIn animated" data-animate="fadeIn" data-delay="1000">
				<div class="fbox-icon">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="feature-box fbox-center fbox-effect border-bottom-0 fadeIn animated" data-animate="fadeIn" data-delay="1200">
				<div class="fbox-icon">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="feature-box fbox-center fbox-effect border-bottom-0 fadeIn animated" data-animate="fadeIn" data-delay="1400">
				<div class="fbox-icon">
		...
		<div class="col-sm-6 col-lg-4">
			<div class="feature-box fbox-center fbox-effect border-bottom-0 fadeIn animated" data-animate="fadeIn" data-delay="1600">
				<div class="fbox-icon">
