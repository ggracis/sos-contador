...
<header
  id="header"
  class="dark full-header transparent-header header-size-custom"
      ...
      <div class="header-row">
        ...
        <div id="logo" class="mr-lg-3">
          <a
            href="#"
            class="standard-logo"
            data-dark-logo="images/logo_top.png"
            ><img src="images/logo_top.png" alt="SOS Contador"
          /></a>
          <a
            href="#"
            class="retina-logo"
          ...
          >
            ...
            <li class="menu-item">
              <a
                ...
                "
                class="button button-fill button-reveal button-medium button-red text-right"
                >REGISTRATE</a
              >
            </li>
            <li class="menu-item">
